...
public class mainApp{
	...
	public static void main(String[] args){
		...
		String menuPath = ".\\Main\\Files\\menu.txt";
		String tablePath = ".\\Main\\Files\\tables.txt";
		String reservationPath = ".\\Main\\Files\\reservations.txt";
		String promoPath = ".\\Main\\Files\\promos.txt";
		String logPath = ".\\Main\\Files\\log.txt";
		String staffPath = ".\\Main\\Files\\staff.txt";
